                ...
                emails: [
                    {
                        ...
                        isImportant: true,
                        isDraft: false,
                        sentAt: (new Date()).getTime() - 100000,
                        removedAt: null,
                        labels: ["amsterdam"],
                        from: 'momo@momo.com',
                        to: 'user1@gmail.com'
                    ...
                    },
                    {
                        ...
                        isImportant: false,
                        isDraft: false,
                        sentAt: (new Date()).getTime() - 300000,
                        removedAt: null,
                        labels: ["games"],
                        from: 'bla@momo.com',
                        to: 'user1@gmail.com'
